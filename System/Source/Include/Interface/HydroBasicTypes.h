...
struct CDC_Save_Old
{
	char Name[64]; //win1251
	char Model[64]; //win1251
	ePipeType Type;
	char Obj1[128]; //win1251
	char Master1[64]; //win1251
	char Ceil1[32]; //win1251
	char Obj2[128]; //win1251
	char Master2[64]; //win1251
	char Ceil2[32]; //win1251
	int kXY;
};
