...
XMLError XMLDocument::SaveFile( const char* filename, bool compact, bool bWpfView )
{
    if ( !filename ) {
        TIXMLASSERT( false );
        SetError( XML_ERROR_FILE_COULD_NOT_BE_OPENED, 0, "filename=<null>" );
    ...
    SaveFile(fp, compact, bWpfView );
    fclose( fp );
    return _errorID;
}


XMLError XMLDocument::SaveFile( FILE* fp, bool compact, bool bWpfView )
{
...
XMLPrinter::XMLPrinter( FILE* file, bool compact, int depth, bool bWpfView ) :
