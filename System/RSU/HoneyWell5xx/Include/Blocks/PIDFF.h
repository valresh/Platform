Enumeration(ADVDEVOPT,"Adv Dev Option",DISABLE,ENABLE,Def=DISABLE)
...
Struct5B(ESWFL,"",ALL,AUTO,BCAS,CAS,MAN)//Ext Mode Switch
Enumeration(FBORSTS,"FB Override Status",NotCon,Sel,NotSel,Def=NotCon)
Real(FF,"Feedforward Input in EUs",0)
Enumeration(FFSTS,"Feedforward Input Status",BAD,UNCERTN,NORMAL,MANUAL,INITACK,INITREQ,INITBAD,Def=BAD)
...
Real(LASTGOODPV,"",NaN)
Enumeration(LASTMODEREQ,"Last value of MODEREQ in RUN",Man,Auto,Cas,None,Def=None)//when SCMMODE is Running.
...
Enumeration(MODE,"",Man,Auto,Cas,BCas,None,Normal,Def=Man)//BackupCascade
Struct4B(MODEATTRFL,"",ALL,NORM,OPER,PROG)
...
Enumeration(SPTVARWOPT,"Pause SP Ramping on Anti-Reset Windup",DISABLE,ENABLE,Def=DISABLE)
