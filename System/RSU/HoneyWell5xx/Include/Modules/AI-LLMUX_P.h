...
String_A(AUXDESC,"Auxiliary Descriptor",40,36)
...
String_A(BOXSFASTATUS,"BOXSFA Status",256,256)
...
String_A(BOXSFBSTATUS,"BOXSFB Status",256,256)
...
Enumeration_A(CALIBSTS,"FTA Calibration Status",4,Disabled,Enabled,Not_Permitted,Def=)
...
String_A(CHNLSFBSTATUS,"CHNLSFB Status",256,256)
...
String_A(CHNLWFAILASTATUS,"CHNLWFAILA Status",128,256)
...
String_A(CHNLWFAILBSTATUS,"CHNLWFAILB Status",128,256)
...
STRUCT(FFBLKLST)
  INTEGER_SA(FFBLKLST,INSTID,64,"Block Instance ID")
  STRING_SA(FFBLKLST,TMPLTID,64,64,"Block Template ID")
  INTEGER_SA(FFBLKLST,VFDINDX,64,"VFD Array Index associated with the Block")
STRUCT_END(FFBLKLST)
Enumeration(FREQ6050,"Frequency 60/50Hz",60Hz,50Hz,Def=)
Enumeration(FREQ6050A,"Frequency 50/60 Hz DPA Part A",60Hz,50Hz,Def=)
Enumeration(FREQ6050B,"Frequency 50/60 Hz DPA Part B",60Hz,50Hz,Def=)
Enumeration_A(FTATYPE,"FTA Type",4,None,TC,RTD,Def=)
...
Enumeration(IOPTYPE,"IOP Type",---,LLAI,HLAI,DI,DO16,AO8,LLMUX,STIMV,DISOE,AO16,DO32,RHMUX,HLAIHART,DI24V,AO16HART,AI_HART,AI_LLMUX,AO_HART,DI_HV,DI_24,DO_24B,DI_SOE,AI_HL,AO,Def=)
...
Enumeration(MODLTYPEA,"Module Type DPA Part A",---,LLAI,HLAI,DI,DO16,AO8,LLMUX,STIMV,DISOE,AO16,DO32,RHMUX,HLAIHART,DI24V,AO16HART,AI_HART,AI_LLMUX,AO_HART,DI_HV,DI_24,DO_24B,DI_SOE,AI_HL,AO,Def=)
Enumeration(MODLTYPEB,"Module Type DPA Part B",---,LLAI,HLAI,DI,DO16,AO8,LLMUX,STIMV,DISOE,AO16,DO32,RHMUX,HLAIHART,DI24V,AO16HART,AI_HART,AI_LLMUX,AO_HART,DI_HV,DI_24,DO_24B,DI_SOE,AI_HL,AO,Def=)
...
Enumeration_A(PTEXECST,"Point Execution State",64,Inactive,Active,Def=)
Real_A(PV,"Process Value",64)
Enumeration_A(PVSTS,"Process Value Status",64,BAD,UNCERTN,NORMAL,MANUAL,INITACK,INITREQ,INITBAD,Def=)
...
Enumeration(SCANRATE,"I/O Link Scan Rate",Priority_IOM,100_ms,200_ms,250_ms,500_ms,1S,2S,Def=)
...
STRUCT(TREND)
  ...
  ENUM_SA(TREND,POSITION,32,"Trend Position",32,1-Cyan,2-White,3-Green,4-Yellow,5-Pink,6-Red,7-Blue,8-Grey,None,Def=)
STRUCT_END(TREND)
