...
BOOL CInPlaceCombo::ShowComboCtrl(DWORD dwStyle, const CRect &rCellRect, CWnd* pParentWnd, UINT uiResourceID, int iRowIndex, int iColumnIndex )
{
...
void CInPlaceCombo::SetDefText( LPCSTR t )
{
  m_strWindowText = t;
  SetWindowText( t );
}
