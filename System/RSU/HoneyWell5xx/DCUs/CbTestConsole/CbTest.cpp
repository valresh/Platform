...
int ServerTest( )
{
  ...
  std::string szPath2State = rsu_cp::makepath_with_ext_cp(GetSavePath(), "testingState", "state").string();
  //_makepath_s( szPath2State, NULL, GetSavePath(), "testingState", "state");
  std::string szPath2Params = rsu_cp::makepath_with_ext_cp(GetParamsPath(), "testingParams", "params").string();
  ...
  IRsuModel *models[] =
  {
    ...
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_001_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_001_2"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_001_3"),// баг
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_001_4"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_001_5"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_001_6"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_001_7"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_001_8"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_002_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_101_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_101_2"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_301_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_411_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_411_2"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_431_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_511_1"),

LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_551_1"),// баг

    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_861_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_911_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_912_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_931_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"ESD_932_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_001_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_001_2"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_001_3"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_001_4"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_002_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_101_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_301_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_411_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_431_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_511_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_551_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_861_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_911_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_912_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_931_1"),
    LoadServer("SafetyManagerH5xx_Server", /*"РСУ_SMH_*/"FGS_932_1"),
  };
  ...
  for (;;)
  {
    ...
    while (bIdle )//&& !::PeekMessage(&msg, NULL, NULL, NULL, PM_NOREMOVE))
    {
        ...
        //duration<double, std::milli> delay = duration_cast<duration<double>>(t2 - t1);
      //double delay = (((double)(llEnd - llStart))/((double)llFreq));
      // call OnIdle while in bIdle state
      lIdleCount++;
      if(secs.count() > deltaStepSec)
      {
          t1 = steady_clock::now();
        ...
        if( s_bLoadState )
        {
          ...
          {
            models[0]->AfterInit();
            models[0]->StateRestore(szPath2State.c_str());
        ...
        if( s_bSaveState )
        {
          s_bSaveState = false;
          if( 1==_countof(models) )
            models[0]->StateSave(szPath2State.c_str());
        }
