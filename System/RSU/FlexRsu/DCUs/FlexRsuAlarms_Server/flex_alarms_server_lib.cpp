...
namespace rsu_cp {
	...
	class RsuServerFlexAlarm : public RsuServer {
		KAlarmServer* m_flex_svr;
	protected:
	...
	public:
		...
		RsuServerFlexAlarm(const RsuSvrObjNames* a_names) : RsuServer(a_names)
		{
			m_flex_svr = new KAlarmServer(a_names->obj_name);
		}
		~RsuServerFlexAlarm()
		{
			delete m_flex_svr;
	...
	protected:
		...
		{
			return std::make_shared<RsuServerFlexAlarm>(a_ObjNames);
		}		
	public:
...
static std::string g_svr_lib = "FlexRsuAlarms_Server";
