...
public:
  ...
  void AddHWs( LPCSTR name, DWORD_PTR hw, DWORD_PTR sh, EValueType eType, UINT nType, UINT len );
  ...
  void AddHW( LPCSTR name, DWORD_PTR hw, DWORD_PTR sh, EValueType eType, UINT nType, int nCount, size_t elSize, LPCSTR pszEnum )
  {
