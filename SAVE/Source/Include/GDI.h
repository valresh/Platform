...
IN_DLL void AddBrush (CGDIResourceMgr *pResMgr, int nType, COLORREF cr);
IN_DLL void AddTextColor (CGDIResourceMgr *pResMgr, int nType, COLORREF cr);
IN_DLL void AddPen (CGDIResourceMgr *pResMgr, int nType, COLORREF cr, int nSize);
IN_DLL void AddFont (CGDIResourceMgr *pResMgr, int nType, COLORREF cr, int nSize, BOOL bBold, LPCTSTR szFaceName);
IN_DLL HBRUSH GetBrush (CGDIResourceMgr *pResMgr, int nModelID, int nType);
IN_DLL COLORREF GetTextColor (CGDIResourceMgr *pResMgr, int nModelID, int nType);
