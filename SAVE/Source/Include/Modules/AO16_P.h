...
/*Enumeration(FAILOPT,"Failure Option",Hold,Unpower,Def=)
STRUCT(FFBLKLST)
...
Real_A(INITVAL,"Echoback Value",16)
...
Enumeration(SCANRATE,"I/O Link Scan Rate",200_ms,250_ms,500_ms,1S,2S,Def=)
