...
Real_A(C,"Scaling Factor for Inputs",10,1)
...
Real_A(D,"Bias Values for Inputs",10,0)
...
Integer(NUMPINPT,"Number of Process Inputs",1)
//Integer(ORDERINCM,"Execution Order in CM")
String_A(PDESC,"Input Description",32 * 4,10)
Boolean_A(PENABLE,"Enable",10,false)
