...
#undef DBLE2
#define DBLE2(Var,VarName,Def,Desc) theList.AddHW( #Var, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueDbl, TypeID );\
                                      theList.AddHW( #VarName, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueDbl, TypeID );

#undef REAL
#define REAL(Var,Def,Desc) theList.AddHW( #Var, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueFlt, TypeID );

#undef INT2
#define INT2(Var,Def,Desc)  theList.AddHW( #Var, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueChr, TypeID );
//theList.AddHW( #Var, offsetof(shareObj,Var), offsetof(netObj,Var), enumValue, TypeID );

#undef INT4
#define INT4(Var,Def,Desc) theList.AddHW( #Var, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueInt, TypeID );

#undef Boolean
#define Boolean(Var,Def,Desc) theList.AddHW( #Var, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueBol, TypeID );

#undef  STRING
#define STRING(Var,Max,Desc) theList.AddHW( #Var, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueStr, TypeID, Max );

#undef  STRING_2
#define STRING_2(Var,VarName,Max,Desc) theList.AddHW( #Var, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueStr, TypeID, Max );\
                                      theList.AddHW( #VarName, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueStr, TypeID, Max );

#undef  ENUMERATION
#define ENUMERATION(Var,Desc,...) theList.AddHW( #Var, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueChr, TypeID, #__VA_ARGS__ );\
  if( Desc[0] )theList.AddHW( Desc, offsetof(shareObj,Var), offsetof(netObj,Var), enumValueChr, TypeID, #__VA_ARGS__ );
