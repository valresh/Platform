...
struct S_fts5s_P
{
#include "PrivateVars/fts5s.h"
  ns_HIMA::KF_TRIG f_trig[5];
  ns_HIMA::KRS rs[5];
  ns_HIMA::KTP tp;
};
...
static KBlockCreator _fts5s("HIMA:fts5s", K_fts5s::Create);

KFlexBlockBase *K_fts5s::Create()
{
  return new K_fts5s;
}

#include <_InitInfo.h>
DECLARE_PRIVATE_VARSINFO( K_fts5s, 35+30+30+6 )
//////////////////////////////////////////////////////////////////////////
void K_fts5s::InitParm()
{
...
void K_fts5s::AssignConnections( KFlexConnection **ppIns, DWORD nIns, KFlexConnection **ppOuts, DWORD nOuts )
{
...
KFlexBlockBase::SReturn K_fts5s::StepCalc( SCallParams &params )
{
  SReturn sr;
  for( DWORD i=0; i<m_nIns; ++i )
  {
