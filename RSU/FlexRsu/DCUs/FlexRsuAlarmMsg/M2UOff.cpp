...
static KBlockCreator _M2U("M2UOFF", K_M2UOff::Create);

KFlexBlockBase *K_M2UOff::Create()
{
  return new K_M2UOff;
}
...
{
  #include <_InitInfo.h>
  DECLARE_PRIVATE_VARSINFO( K_M2UOff, 10 )
  DECLARE_SHARED_VARSINFO( S_M2U, 5 )
}
//////////////////////////////////////////////////////////////////////////
using namespace ns_M2UOff;
void K_M2UOff::InitParm()
{
...
void K_M2UOff::AssignConnections( KFlexConnection **ppIns, DWORD nIns, KFlexConnection **ppOuts, DWORD nOuts )
{
...
KFlexBlockBase::SReturn K_M2UOff::StepCalc( SCallParams &params )
{
  SReturn sr;
