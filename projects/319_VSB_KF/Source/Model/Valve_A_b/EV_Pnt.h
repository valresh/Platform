...
TAB("Параметры", 1 )
	...
	PARM_B(MoveOnSignal, "Движение по сигналу", false)
...
ETAB
TAB("Поле", 1)
	PARM_LL((unsigned int&)eSwitch, "#Мест-Дист", "Дистанционный;Местный;Универсальный;")	
	PARM(bOpen, "#Команда \'Открыть\'")
	PARM(bClose, "#Команда \'Закрыть\'")
	PARM(bStop, "#Команда \'Стоп\'")
