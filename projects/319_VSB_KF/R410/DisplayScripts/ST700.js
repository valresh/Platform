...
/// \file  ST700.js
///
/// \brief Java script file to contain data arrays that are specific to the ST700 transmitter.
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// History:
...
/// [RLEAPFI-642]   April 30, 2018      Add support for building a ST700 specific device model.
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// ST700_NumberOfStatusBytes = [{ Revision: , Cmd48: , Cmd220: }]
///
...
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var ST700_NumberOfStatusBytes =
[
    { "Revision": 1, "Cmd48": 3, "Cmd220": 8 },
    { "Revision": 2, "Cmd48": 3, "Cmd220": 8 },
    { "Revision": 3, "Cmd48": 3, "Cmd220": 8 },
    { "Revision": 4, "Cmd48": 3, "Cmd220": 8 },
    { "Revision": 5, "Cmd48": 3, "Cmd220": 8 }
];

var ST700_DeviceRevisions =
{
    1: new SL_DeviceRevision(1, 3, 8),
    2: new SL_DeviceRevision(2, 3, 8),
    3: new SL_DeviceRevision(3, 3, 8),
    4: new SL_DeviceRevision(4, 3, 8),
    5: new SL_DeviceRevision(5, 3, 8)
};


//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// ST700_Cmd48StatusBits = [{ Byte: , Bit: , Criticality: , Name: , Description: , Resolution: }]
///
/// This array indicates the position, name, criticality, cause and resolution information for each status bit defined for the ST700 transmitter
...
[
    ...
    },
    {
        ...
        "resolution": "Perform DAC calibration for precise analog output measurement and the devie will be usable."
    },
    {
        "byte": 2,
        "bit": 5,
        ...
        "resolution": "See the User's Manual 34-ST-25-44 for Tamper Alarm configuration."
    },
    {
        "byte": 2,
        "bit": 4,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// ST700_Cmd220StatusBits = [{ Byte: , Bit: , Criticality: , Name: , Description: , Resolution: }]
///
/// This array indicates the position, name, criticality, cause and resolution information for each status bit defined for the ST700 transmitter
...
[
    ...
    },
    {
        ...
        "resolution": "Power cycle the device. If the problem still persists after power cycle then ROM might be damaged so need to replace the communication module.\n\nBefore replacing the communication module ensure that the device is operating in environment which falls under the specifications as mentioned in the User's Manual 34-ST-25-44."
    },
    {
        "byte": 1,
        "bit": 0,
    ...
    },
    {
        ...
        "resolution": "Power cycle the device and check the local display connectivity. Secure Display connections and recheck. Refer to Maintenance in User's Manual 34-ST-25-44 for more details about how to connect the display module with Communication module.\nIf problem still persists, replace the display module."
    },
    {
        "byte": 2,
        "bit": 0,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// ST700_ModuleTypeEnumeration = {{ Name: , Abbreviation: }}
///
/// This enum defines the name and abbreviation associated with each of the valid values of the ModuleType enumeration.
/// This enumeration contains the valid definitions for the different pressure module types in terms of the ype of pressure measured. This
...
/// ST700 Device Model
///
/// Initialize the global SL_Transmitter object to represent a ST700 transmitter. This global device model will be accessed by numerous global
...
SL_Device.expectedModel = "ST700";
SL_Device.deviceVariables = ST700_DeviceVariables;
...
SL_Device.deviceRevisions = ST700_DeviceRevisions;

SL_Device.command48.numberOfBytes = ST700_DeviceRevisions[1].command48StatusBytes;
SL_Device.command48.statusBits = ST700_Cmd48StatusBits;

SL_Device.command220.numberOfBytes = ST700_DeviceRevisions[1].command220StatusBytes;
SL_Device.command220.statusBits = ST700_Cmd220StatusBits;

SL_Device.command220.statusBytes.length = SL_Device.command220.numberOfBytes;

ST700_PressureModule = new SL_PressureModule();
ST700_PressureModule.moduleTypes = ST700_ModuleTypes;

SL_Device.module = ST700_PressureModule;
