...
/// \file  STT750.js
///
/// \brief Java script file to contain enumerations and functions that are specific to the STT750 transmitter.
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// History:
...
/// [RLEAPFI-475]   May   28, 2018      Added "None" to the supported temperature sensor IDs.
/// EXP510.1-35		May   27, 2018		Developer Label D_EXP510.1-35.0-06
/// EXP510.1-34		May   21, 2018		Developer Label D_EXP510.1-34.0-12
/// [RLEAPFI-642]	April 30, 2018		Add support for building a STT750 specific device model.
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_NumberOfStatusBytes = [{ Revision: , Cmd48: , Cmd220: }]
///
...
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var STT750_NumberOfStatusBytes =
[
    { "Revision": 1, "Cmd48": 4, "Cmd220": 8 },
    { "Revision": 2, "Cmd48": 4, "Cmd220": 8 }
];

var STT750_DeviceRevisions =
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_Cmd48StatusBits = [{ Byte: , Bit: , Criticality: , Name: , Description: , Resolution: }]
///
/// This array indicates the position, name, criticality, cause and resolution information for each status bit defined for the STT750 transmitter
...
[
    ...
    },
    {
        ...
        "resolution": " If the temperature is > 85°C and if compensation is Internal CJ (range is -40 to 85°C), accuracy and life span may decrease if internal CJ remains overrange. As long as transmitter is isolated from the temperature source, there will not be any degradation. Take steps to isolate the device from the temperature source. If the environmental conditions are met, and problem still persists, then replace the sensor module/Terminal Block Assembly."
    },
    {
        "byte": 1,
        "bit": 2,
...

    {
        ...
        "bit": 6,
        "criticality": 1,
        "name": "Sensor Input Out of Range",
        "description": "Sensor input is either under or over its specified range.",
    ...
    },
    {
        ...
        "description": "Indicates that sensor is operating in low power mode. This indicates that the transmitter is operating in a reduced accuracy mode due to a critical failure.",
        "resolution": "Power cycle device to exit sensor module/Terminal Block Assembly from low power mode."
    },
    {
        "byte": 3,
        "bit": 3,
        "criticality": 1,
        "name": "Sensor Input Open",
        "description": "Sensor Input Open",
        "resolution": "Make sure the temperature sensor wiring is connected to the correct terminals and is secure."
    },
    {
        "byte": 3,
        "bit": 2,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_Cmd220StatusBits = [{ Byte: , Bit: , Criticality: , Name: , Description: , Resolution: }]
///
/// This array indicates the position, name, criticality, cause and resolution information for each status bit defined for the STT750 transmitter
...
[
...

    {
        ...
        "description": "Input Terminal TB7 is open. Applicable to RTD and Ohm sensors only.",
        "resolution": "Make sure that the correct sensor type has been configured. Make sure the temperature sensor wiring is connected to the correct terminals and is secured."
    },
    {
        "byte": 2,
        "bit": 4,
        ...
        "description": "Input terminal TB8 is open. Applicable to 4 wire RTD and Ohm sensors only.",
        "resolution": "Make sure that the correct sensor type has been configured. Make sure the temperature sensor wiring is connected to the correct terminals and is secured."
    },
    {
        "byte": 2,
        ...
        "description": "Input terminal TB6 is open. Applicable to RTD and Ohm sensors only.",
        "resolution": "Make sure that the correct sensor type has been configured. Make sure the temperature sensor wiring is connected to the correct terminals and is secured."
    },
    {
        "byte": 2,
    ...
    },
    {
        ...
        "description": "Input Terminal TB5 is open. Applicable to RTD and Ohm sensors only.",
        "resolution": "Make sure that the correct sensor type has been configured. Make sure the temperature sensor wiring is connected to the correct terminals and is secured."
    },
    ...
    },
    {
        ...
        "resolution": "Verify environment is within spec."
    },
    {
        "byte": 3,
        "bit": 1,
    ...
    },
    {
        ...
        "bit": 3,
        "criticality": 0,
        "name": "Input or CJ Value Bad",
        "description": "Input or Cold Junction temperature reading is bad.",
        "resolution": "Check if the sensor wiring is connected correctly. If it is, check the sensor ranges configured are right for the process. If they are, power cycle the device. If the issue persists, then replace the sensor module/Terminal Block Assembly."
    },
    {
        "byte": 4,
        "bit": 2,
...

    {
        ...
        "bit": 6,
        "criticality": 0,
        "name": "Input Sensor Fault",
        "description": "Temperature input reading is bad.",
        "resolution": "Check if the input sensor matches the configuration and is wired correctly. If it does, check that the configured sensor range is right for the process. If it is, power cycle the device. If the issue persists, then replace the sensor module/Terminal Block Assembly."
    },
    {
        "byte": 5,
        "bit": 5,
    ...
    },
    {
        ...
        "bit": 3,
        "criticality": 0,
        "name": "Input Value Bad",
        "description": "Input value is bad.",
        "resolution": "Check if the input sensor matches the configuration and is wired correctly. If it is, check the sensor range configured is right for the process. If it is, power cycle the device. If the issue persists, then replace the sensor module/Terminal Block Assembly."
    },
    {
        "byte": 5,
        "bit": 2,
        ...
        "description": "User Corrects have been activated for the input sensor.",
    ...
    },
    {
        ...
        "bit": 0,
        "criticality": 0,
        "name": "Excess Correction",
        "description": "The value applied during Calibration is too far away from the CAL point of the input sensor.",
        "resolution": "Perform a Reset Corrects. Perform an LRV Correct on the sensor first, checking that the applied input matches the sensor Lower Calibration Point value.  Next, perform the URV Correct, checking that the input matches the sensor Upper Calibration Point value."
    },
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_InputSensorTypes = { Type: }
///
/// This enumeration contains the valid definitions for the style of temperatue sensing elements that can be connected to the STT750 temperature
...
/// that can be connected to the STT750 temperature transmitter. This enumeration is based on Device Revision 4 of the HART sensor firmware and is
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_InputSensorWires = { Wires: , Description: }
///
...
/// elements that can be connected to the STT750 temperature transmitter. This enumeration is based on Device Revision 4 of the HART sensor
/// firmware and is expected to be applied to:
///     rtd1_type  variable as read through device specific command 136
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var STT750_InputSensorWires =
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_ColdJunctionTemperatureSources = { Source: }
///
/// This enumeration contains the valid definitions for the source of the cold junction temperature input that can be used by the STT750
...
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var STT750_ColdJunctionTemperatureSources =
{
    0: { Source: "Internal" },
    1: { Source: "External" } ,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_BreakDetectionModes = { Mode: }
///
/// This enumeration contains the valid definitions for the different modes of the Break Detection function that can be used by the STT750
/// temperature transmitter. This enumeration is based on Device Revision 4 of the HART sensor firmware and is expected to be applied to:
///     break_detect_mode variable as read through device specific command 135
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var STT750_BreakDetectionModes =
{
    0: { Mode: "Disabled" },
    1: { Mode: "Enabled" }
};
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_PVCalculationModes = { Mode: }
///
/// This enumeration contains the valid definitions for the different modes of calculating the output PV Temperature in the STT750
/// temperature transmitter. This enumeration is based on Device Revision 4 of the HART sensor firmware and is expected to be applied to:
///     loop_control_choice variable as read through device specific command 188
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var STT750_PVCalculationModes =
{
    0: { Mode: "Average" },
    1: { Mode: "Differential" },
    2: { Mode: "Sensor 1" },
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_PVCalculationSources = { Source: }
///
...
/// in the STT750 temperature transmitter. This enumeration is based on Device Revision 4 of the HART sensor firmware and is expected to be
/// applied to:
///     contolling_var variable as read through device specific command 188
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var STT750_PVCalculationSources =
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_MatchSensorsModes = { Mode: }
///
/// This enumeration contains the valid definitions for the different modes of the Match Sensors function that can be used by the STT750
/// temperature transmitter. This enumeration is based on Device Revision 4 of the HART sensor firmware and is expected to be applied to:
///     match_pvs variable as read through device specific command 135
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var STT750_MatchSensorsModes =
{
    0: { Mode: "Disabled" },
    1: { Mode: "Enabled" }
};
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_ExcessDeltaDetectionModes = { Mode: }
///
...
/// the STT750 temperature transmitter. This enumeration is based on Device Revision 4 of the HART sensor firmware and is expected to be applied to:
///     xs_delta_detection variable as read through device specific command 223
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var STT750_ExcessDeltaDetectionModes =
{
    0: { Mode: "Disabled" },
    1: { Mode: "Enabled" }
};
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// STT750_LocalDisplayTypes = { Mode: }
///
/// This enumeration contains the valid definitions for the different locsl display types that can be connected to the STT750 temperature
/// transmitter. This enumeration is based on Device Revision 4 of the HART sensor firmware and is expected to be applied to:
///     display_type_code  variable as read through device specific command 134
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var STT750_LocalDisplayTypes =
{
    0: { Mode: "None" },
    1: { Mode: "Advanced" },
    2: { Mode: "Basic" },
...
/// STT750 Device Model
///
/// Initialize the global SL_Transmitter object to represent a STT750 transmitter. This global device model will be accessed by numerous global
...
SL_Device.expectedModel = "STT750";
SL_Device.deviceVariables = STT750_DeviceVariables;
...
SL_Device.deviceRevisions = STT750_DeviceRevisions;

SL_Device.command48.numberOfBytes = STT750_DeviceRevisions[1].command48StatusBytes;
SL_Device.command48.statusBits = STT750_Cmd48StatusBits;

SL_Device.command220.numberOfBytes = STT750_DeviceRevisions[1].command220StatusBytes;
SL_Device.command220.statusBits = STT750_Cmd220StatusBits;

SL_Device.command220.statusBytes.length = SL_Device.command220.numberOfBytes;

STT750_TemperatureModule = new SL_TemperatureModule();
STT750_TemperatureModule.PvCalculationSources = STT750_PVCalculationSources;
STT750_TemperatureModule.inputSensorTypes = STT750_InputSensorTypes;
STT750_TemperatureModule.inputSensorIDs = STT750_InputSensorIDs;
STT750_TemperatureModule.inputSensorWires = STT750_InputSensorWires;

SL_Device.module = STT750_TemperatureModule;