   ...
   if (oSource.QualityGood("TagName." + sFBName + ".pveuhi") && oSource.QualityGood("TagName." + sFBName + ".pveulo"))
    {
        ...
        if ((oSource.DataValue("TagName." + sFBName + ".pvhhalm.pr") != 0) && (oSource.DataValue("TagName." + sFBName + ".pvhhalm.pr") != 1))
        {
            var iTrip = oSource.DataValue("TagName." + sFBName + ".pvhhalm.tp");
            var iPriority = oSource.DataValue("TagName." + sFBName + ".pvhhalm.pr");
        ...
        if ((oSource.DataValue("TagName." + sFBName + ".pvhialm.pr") != 0) && (oSource.DataValue("TagName." + sFBName + ".pvhialm.pr") != 1))
        {
            var iTrip = oSource.DataValue("TagName." + sFBName + ".pvhialm.tp");
            var iPriority = oSource.DataValue("TagName." + sFBName + ".pvhialm.pr");
            if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
            {
                var tripRange = pvEUHi - iTrip;
        ...
        if ((oSource.DataValue("TagName." + sFBName + ".pvllalm.pr") != 0) && (oSource.DataValue("TagName." + sFBName + ".pvllalm.pr") != 1))
        {
            var iTrip = oSource.DataValue("TagName." + sFBName + ".pvllalm.tp");
            var iPriority = oSource.DataValue("TagName." + sFBName + ".pvllalm.pr");
            if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
            {
        ...
        if ((oSource.DataValue("TagName." + sFBName + ".pvloalm.pr") != 0) && (oSource.DataValue("TagName." + sFBName + ".pvloalm.pr") != 1))
        {
            var iTrip = oSource.DataValue("TagName." + sFBName + ".pvloalm.tp");
            var iPriority = oSource.DataValue("TagName." + sFBName + ".pvloalm.pr");
            if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
            {
                var tripRange = iTrip - pvEULo;
