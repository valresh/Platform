...
{
  if (oSource.QualityGood("TagName.euhi") && oSource.QualityGood("TagName.eulo"))
  {
    ...
    if (oSource.QualityGood("TagName.euhi") && oSource.QualityGood("TagName.eulo"))
    {
      var pvEUHi = oSource.DataValue("TagName.euhi");
      var pvEULo = oSource.DataValue("TagName.eulo");
      var pvRange = pvEUHi - pvEULo;
    }
    if (oSource.QualityGood("TagName.units"))
    {
      var sEUDesc = oSource.DataValue("TagName.units");
    }
    for (var i = 1; i <= 8; i++)
    {
      if ((oSource.DataValue("TagName.alarmtype" + i) == 9) && (oSource.DataValue("TagName.alarm" + i + "priority") != 0))
      {
        var iTrip = oSource.DataValue("TagName.alarmlimit" + i);
        var iPriority = oSource.DataValue("TagName.alarm" + i + "priority");
        if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
        {
          ...
          arrAlarmLimitsInfo[0] = "PV High High: " + iTrip.toFixed(2) + " " + sEUDesc;
        }
      }
      if ((oSource.DataValue("TagName.alarmtype" + i) == 7) && (oSource.DataValue("TagName.alarm" + i + "priority") != 0))
      {
        var iTrip = oSource.DataValue("TagName.alarmlimit" + i);
        var iPriority = oSource.DataValue("TagName.alarm" + i + "priority");
        if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
        {
          ...
          arrAlarmLimitsInfo[1] = "PV High:           " + iTrip.toFixed(2) + " " + sEUDesc;
        }
      }
      if ((oSource.DataValue("TagName.alarmtype" + i) == 8) && (oSource.DataValue("TagName.alarm" + i + "priority") != 0))
      {
        var iTrip = oSource.DataValue("TagName.alarmlimit" + i);
        var iPriority = oSource.DataValue("TagName.alarm" + i + "priority");
        if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
        {
          ...
          arrAlarmLimitsInfo[6] = "PV Low Low:    " + iTrip.toFixed(2) + " " + sEUDesc;
        }
      }
      if ((oSource.DataValue("TagName.alarmtype" + i) == 6) && (oSource.DataValue("TagName.alarm" + i + "priority") != 0))
      {
        var iTrip = oSource.DataValue("TagName.alarmlimit" + i);
        var iPriority = oSource.DataValue("TagName.alarm" + i + "priority");
        if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
        {
          ...
          arrAlarmLimitsInfo[5] = "PV Low:            " + iTrip.toFixed(2) + " " + sEUDesc;
        }
      }
    }
    ...
    if (olimitsData.limitsData.limits[i].targetRange == true)
    {
      ...
      if (typeof(olimitsData.limitsData.limits[i].low) != "undefined")
      {
        ...
        if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
        {
          ...
          arrAlarmLimitsInfo[4] = sOperatingName + " Limit Low:  " + iTrip.toFixed(2) + " " + sEUDesc;
        }
      }
      if (typeof(olimitsData.limitsData.limits[i].high) != "undefined")
      {
        ...
        if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
        {
          ...
          arrAlarmLimitsInfo[2] = sOperatingName + " Limit High: " + iTrip.toFixed(2) + " " + sEUDesc;
        }
      }
      if ((typeof(olimitsData.limitsData.limits[i].aim) != "undefined"))
      {
        ...
        if (pvEULo <= iTrip && iTrip <= pvEUHi && iTrip != null && isNaN(iTrip) == false && isFinite(iTrip) == true)
        {
          ...
          arrAlarmLimitsInfo[3] = sOperatingName + " " + "Aim:           " + " " + iTrip.toFixed(2) + " " + sEUDesc;
        }
      }
    }
  }
