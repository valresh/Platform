...
[
    ...
    'text!./StsStsLnkTemplate.htm', 'asari/viewmodels/PointParamViewModel'
],
// Dependencies will be available as function arguments.
function(StsStsLnkTemplate, PointParamViewModel) {
    ...
    StsStsLnkShape.init = function(config) {
        StsStsLnkShape._config = config;
        return true;
    };
    ...
    //   template.
    StsStsLnkShape.getViewTemplates = function() {
        return {
            extStsStsLnkTemplate: StsStsLnkTemplate,
            MAIN_VIEW_TEMPLATE: 'extStsStsLnkTemplate' // This is not strictly required for a single view template.
        };
    };
    ...
    StsStsLnkShape.getBindings = function() {
        return null;
    };
    ...
    StsStsLnkShape.getDependencies = function() {
        return ['status', 'link'];
    }
    ...
    StsStsLnkShape.createViewModel = function() {
        return new PointParamViewModel.MultiPointParamViewModel(['linka', 'linkb', 'channel']);
    };

    return StsStsLnkShape;
});
