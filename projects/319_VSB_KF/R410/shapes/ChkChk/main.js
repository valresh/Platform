...
[
    ...
    'text!./ChkChkTemplate.htm', 'asari/viewmodels/PointParamViewModel'
],
// Dependencies will be available as function arguments.
function(CheckboxVisibility, ChkChkTemplate, PointParamViewModel) {
    ...
    ChkChkShape.init = function(config) {
        ChkChkShape._config = config;
        return true;
    };
    ...
    //   template.
    ChkChkShape.getViewTemplates = function() {
        return {
            extChkChkTemplate: ChkChkTemplate,
            MAIN_VIEW_TEMPLATE: 'extChkChkTemplate' // This is not strictly required for a single view template.
        };
    };
    ...
    ChkChkShape.getBindings = function() {
	  return {
        esteCheckBoxVisibility: CheckboxVisibility
      };
    };

    // ### getDependencies() function
    // Return an array containing names of shapes that will be nested within this shape. This function will be
    // called once upon registration of the shape module.
    //
    // Dependencies may be a custom shape or one of the system-defined display elements:
    //
    // * alarmicon
    // * alphanumeric
    // * checkbox
    ...
    //
    // #### Notes:
    // * This function can return an empty array, null or omitted altogether.
    ChkChkShape.getDependencies = function() {
        return ['checkbox'];
    }
    ...
    ChkChkShape.createViewModel = function() {
        return new PointParamViewModel.MultiPointParamViewModel(['linka', 'linkb','linkaimpl','linkbimpl']);
    };
