...
[
    ...
    'text!./StsTxtTemplate.htm', 'asari/viewmodels/PointParamViewModel'
],
// Dependencies will be available as function arguments.
function(StatusBinding, StsTxtTemplate, PointParamViewModel) {
    ...
    StsTxtShape.init = function(config) {
        StsTxtShape._config = config;
        return true;
    };
    ...
    //   template.
    StsTxtShape.getViewTemplates = function() {
        return {
            extStsTxtTemplate: StsTxtTemplate,
            MAIN_VIEW_TEMPLATE: 'extStsTxtTemplate' // This is not strictly required for a single view template.
        };
    };
    ...
    StsTxtShape.getBindings = function() {
        StatusBinding.shapesPath = StsTxtShape._config.shapesPath;
        return {
    ...
    StsTxtShape.createViewModel = function() {
