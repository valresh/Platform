...
[
    ...
    'text!./statusTemplate.htm'
],
// Dependencies will be available as function arguments.
function(StatusBinding, statusTemplate) {
    ...
    ShapeModule.getViewTemplates = function() {
        return {
            extStatusTemplate: statusTemplate,
            MAIN_VIEW_TEMPLATE: 'extStatusTemplate' // This is not strictly required for a single view template.
        };
    }
    ...
    ShapeModule.getBindings = function() {
        StatusBinding.shapesPath = ShapeModule._config.shapesPath;
        return {
