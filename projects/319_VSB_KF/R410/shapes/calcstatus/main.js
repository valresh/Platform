...
[
    ...
    'text!./calcStatusTemplate.htm',
	'asari/viewmodels/PointParamViewModel'
],
// Dependencies will be available as function arguments.
function(CalcStatusBinding, calcStatusTemplate, PointParamViewModel) {
    ...
    ShapeModule.getViewTemplates = function() {
        return {
            extCalcStatusTemplate: calcStatusTemplate,
            MAIN_VIEW_TEMPLATE: 'extCalcStatusTemplate' // This is not strictly required for a single view template.
        };
    }
    ...
    ShapeModule.getBindings = function() {
        CalcStatusBinding.shapesPath = ShapeModule._config.shapesPath;
        return {
            extCalcStatus: CalcStatusBinding
        }
    }
    ...
    ShapeModule.createViewModel = function() {
        return new PointParamViewModel.MultiPointParamViewModel(['status', 'description']);
    }
