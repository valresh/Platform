...
[
    ...
    'text!./atmosLeakTxtSts.htm', 'asari/viewmodels/PointParamViewModel'
],
// Dependencies will be available as function arguments.
function(atmosLeakTxtStsBinding, atmosLeakTxtSts, PointParamViewModel) {

    // ### Initialisation
    var AtmosTxtStsShape = {
    ...
    AtmosTxtStsShape.init = function(config) {
        AtmosTxtStsShape._config = config;
        return true;
    };
    ...
    //   template.
    AtmosTxtStsShape.getViewTemplates = function() {
        return {
            extAtmosLeakTxtSts: atmosLeakTxtSts,
            MAIN_VIEW_TEMPLATE: 'extAtmosLeakTxtSts' // This is not strictly required for a single view template.
        };
    };
    ...
    AtmosTxtStsShape.getBindings = function() {
        atmosLeakTxtStsBinding.shapesPath = AtmosTxtStsShape._config.shapesPath;
        return {
            extAtmosOverviewStatus: atmosLeakTxtStsBinding
        };
    };
    ...
    AtmosTxtStsShape.createViewModel = function() {
        return new PointParamViewModel.MultiPointParamViewModel(['link', 'text']);
    };

    return AtmosTxtStsShape;
});
