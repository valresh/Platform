...
[
    ...
    'text!./StsStsTxtTemplate.htm', 
	'asari/viewmodels/PointParamViewModel',
	'./StsStsTxtViewModel'
],
// Dependencies will be available as function arguments.
function(StatusBinding, StsStsTxtTemplate, PointParamViewModel, StsStsTxtViewModel) {
  var __hasProp = {}.hasOwnProperty,
    ...
    StsStsTxtShape.init = function(config) {
        StsStsTxtShape._config = config;
        return true;
    };
    ...
    //   template.
    StsStsTxtShape.getViewTemplates = function() {
        return {
            extStsStsTxtTemplate: StsStsTxtTemplate,
            MAIN_VIEW_TEMPLATE: 'extStsStsTxtTemplate' // This is not strictly required for a single view template.
        };
    };
    ...
    StsStsTxtShape.getBindings = function() {
        StatusBinding.shapesPath = StsStsTxtShape._config.shapesPath;
        return {
            extStatus: StatusBinding
        };
    };
    ...
    StsStsTxtShape.createViewModel = function() {
        return new PointParamViewModel.MultiPointParamViewModel(['linka', 'linkb', 'aggregate'], null, StsStsTxtViewModel);
    };

    return StsStsTxtShape;
});
